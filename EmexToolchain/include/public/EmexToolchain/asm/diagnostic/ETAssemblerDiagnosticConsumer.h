...
#ifndef ETASSEMBLERDIAGNOSTICCONSUMER_H
#define ETASSEMBLERDIAGNOSTICCONSUMER_H

#include <EmexFoundation/EmexFoundation.h>
#include <EmexToolchain/asm/diagnostic/consumer.h>
...
ETAssemblerDiagnosticConsumerRef ETAssemblerDiagnosticConsumerCreate(EFAllocatorRef allocatorRef, ETAssemblerDiagnosticOptions diagnosticOptions);
...
#endif /* ETASSEMBLERDIAGNOSTICCONSUMER_H */
